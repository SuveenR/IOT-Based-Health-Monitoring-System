...
const char* ssid = "Suveen";  // Enter SSID here
...
//  ptr += "xhttp.send();\n";
ptr += "console.log(heart,spo2);\n";
ptr += "const xhttp = new XMLHttpRequest();\n";
//ptr += " xhttp.onload = function() {\n";
// ptr += "  document.body.innerHTML = this.responseText; }\n";

 ptr +=" xhttp.open('GET', `http://50.18.240.111/nodemcu/index/upload_heart.php?heartbeat=${heart}&spo2=${spo2}`,true);\n";
 ptr +=" xhttp.send();\n";
  ptr += "}\n";
  ptr += "</script>\n";
  //Ajax Code END
